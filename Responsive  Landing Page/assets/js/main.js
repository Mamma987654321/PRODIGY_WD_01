...
const scrollHeader = () => {
    ...
    // when the scroll is grater than 50 viewport height, add the scroll-header class
...
// Activate/ Deactivate the theme normally with the button
...
sr.reveal(`.home__images`, {dealy: 600, origin: 'bottom'})
